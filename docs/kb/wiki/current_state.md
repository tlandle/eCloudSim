...
RE-CHECK QUEUED (bjkiimy4f, a{4,5} shift-40): confirm warm src=migrated consistently + WAIT, kf src=none + GO. SEED CHECK running (b6dlghbzo). Full maneuvering panel (3 shifts around -40 x a=5[or4] x 20 paired seeds, full min-TTC distribution) HELD for the re-check (fix confirmed) + seed band.
