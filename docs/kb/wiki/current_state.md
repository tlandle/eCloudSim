...
RE-CHECK RUNNING (bjkiimy4f, a{4,5} shift-40 with the accel fix): confirm warm src=migrated consistently + WAIT, kf src=none + GO. Full maneuvering panel (3 shifts around -40 x a=5[or4] x 20 paired seeds @ band 4m, full min-TTC distribution + success rate) HELD for the re-check to confirm the accel fix holds.
