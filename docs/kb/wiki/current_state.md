...
ORDERED pre-campaign work (peer): (1) Defect A delivery-floor fix; (2) shift mapping (cetus probe already ran, sign-off pending); (3) relay smoke. Then the whole-campaign rerun on freeze-1m. Defect B no longer blocks.
