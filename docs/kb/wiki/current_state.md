...
- ANOMALY: T12 bo on 1i is non-monotone in load: no-contact runs N=4 3/5, 8 1/5, 12-20 0/5, 24 5/5, 31 2/5 while AGEROW p95 is 600 ms flat through N=20, 800 at 24, 1200 at 31 (same age axis as 1f, which was clean 5/5 through N=20). Not an age effect. The N=24 "clean" runs never launch the overtake (ego x=297, v=0.5 at tick 400, run ends tick 565): no contact but no completion. "No contact" is not "completed"; my RUNROW episodes tally overstated success. Also: 1i t12_bo runs are mode=warm with 7 transfers (migration in play); whether 1f T12 was also warm is being confirmed.
