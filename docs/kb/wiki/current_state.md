...
**Status (2026-08-22):** Sequential baseline (Step 0 two-edge bring-up + Step 1 cold measurement) is now solid — 3 consecutive clean runs, 0 collisions, `MEASURED=29 ticks` reproducible. Three unrelated regressions found and fixed along the way (see below). Warm-import comparison run is next.
