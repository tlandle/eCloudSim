...
DO NOT start the whole-campaign rerun until the attributed verify confirms the v2 fix (warm first-DST-MTR within ~1 cycle of commit; kf late). Defect A, the finer probe sign-off, and the relay smoke also wait.
