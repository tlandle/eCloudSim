...
from ecloud.core.common.misc import get_speed
from ecloud.core.sensing.perception import sensor_transformation as st
...
class DataDumper(object):
    ...
    ----------
    rgb_camera : list
        A list of ecloud.CameraSensor that containing all rgb sensor data
