...
from ecloud.core.common.misc import get_speed, positive, cal_distance_angle
from ecloud.core.plan.collision_check import CollisionChecker
from ecloud.core.plan.local_planner_behavior import LocalPlanner
...
class BehaviorAgent(object):
    ...
    def run_step(
        ...
        if len(self.get_local_planner().get_waypoints_queue()) == 0 \
            ...
            logger.debug('Destination Reset!')
