...
import ecloud.core.sensing.perception.sensor_transformation as st
from ecloud.core.common.misc import \
    cal_distance_angle, get_speed, get_speed_sumo
from ecloud.core.sensing.perception.obstacle_vehicle import \
    ObstacleVehicle
from ecloud.core.sensing.perception.static_obstacle import TrafficLight
from ecloud.core.sensing.perception.o3d_lidar_libs import \
...
class PerceptionManager:
    ...
    def deactivate_mode(self, objects):
        ...
        # convert carla.Vehicle to ecloud.ObstacleVehicle if lidar
    ...
    def destroy(self):
        ...
        if self.data_dump or self.semantic_lidar:
